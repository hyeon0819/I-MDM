...
def add_base_options(parser):
    ...
    group.add_argument("--batch_size", default=500, type=int, help="Batch size during training.")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'ntu120', 'ntu120_tp'], type=str,
